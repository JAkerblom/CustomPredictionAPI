...
namespace CustomerAMLServiceAPI.Services
{
    ...
    public class AzureBESClassFromDocumentation
    {
        ...
        public AzureBESClassFromDocumentation()
        {
        }
        ...
        public static void UploadFileToBlob(string inputFileLocation, string inputBlobName, string storageContainerName, string storageConnectionString)
        {
            ...
            container.CreateIfNotExists(); // Create new container if it doesn't exist
        ...
        //public static async Task InvokeBatchExecutionService()
        {
            ...
            //const string BaseURI = "samma url fast utan jobs?";
            const string BaseUrl = "https://europewest.services.azureml.net/workspaces/3fadc55951da46828a105146f089a9f5/services/d228855c1f024469b605fecfbe0f5129/jobs";
